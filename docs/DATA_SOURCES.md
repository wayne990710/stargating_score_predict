...
| 國立中央大學鹿林天文台 氣象站與雲感測器原始檔 | 氣象站逐分鐘（2009–2025，每年 60–70 MB）；Boltwood 雲感測器約 10 分鐘（2012–2024，天空溫度、環境溫度、雲況代碼） | https://www.lulin.ncu.edu.tw/download/weather/ 公開目錄，2026-09-12 下載至 `%LOCALAPPDATA%\hehuan_cache\lulin\`（不進 repo，約 1.1 GB） | 網站公開提供，未標示授權；僅供本專題研究使用，引用時註明中央大學鹿林天文台。 |
